...
from utils.bd_img_transform.wavelet import waveletImageAttack
from utils.bd_img_transform.wpba import wpbaImageAttack
from utils.bd_img_transform.waba import wabaImageAttack 
...
def bd_attack_img_trans_generate(args):
    ...
    if args.attack in ['badnet','ribac']:
        ...
        train_bd_transform = general_compose([
            ...
            float(args.attack_train_wavelet_alpha),args.dataset, args.pratio),True) # 0.1,
        ])
        ...
        test_bd_transform = general_compose([
            ...
            float(args.attack_test_wavelet_alpha),args.dataset, args.pratio), True) # 0.1,
        ])

    elif args.attack == 'waba':
        ...
        train_bd_transform = general_compose([
            ...
            float(args.attack_train_wavelet_alpha)), True) # 0.1,
        ])
        ...
        test_bd_transform = general_compose([
            ...
            float(args.attack_test_wavelet_alpha)), True) # 0.1,
        ])


    elif args.attack == 'wpba':
        ...
        train_bd_transform = general_compose([
            ...
            float(args.attack_train_wavelet_alpha),args.dataset), True) # 0.1,
        ])
        ...
        test_bd_transform = general_compose([
            ...
            float(args.attack_test_wavelet_alpha),args.dataset), True) # 0.1,
        ])
    ...
    elif args.attack in ['SSBA', 'label_consistent']:
        train_bd_transform = general_compose([
            (transforms.Resize(args.img_size[:2]), False),
            (np.array, False),
