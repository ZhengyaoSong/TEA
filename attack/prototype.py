...
class NormalCase:
    ...
    def set_args(self, parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
        ...
        parser.add_argument('--dataset_path', type=str,default='/workspace/songzhengyao/bdzoo_cifar10/data')
    ...
    def prepare(self, args):
        ...
        if 'save_folder_name' not in args:
            save_path = generate_save_folder(
                run_info=('afterwards' if 'load_path' in args.__dict__ else 'attack') + '_' + (args.attack if 'attack' in args.__dict__ else "prototype"),
